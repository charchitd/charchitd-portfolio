...
const projects: Project[] = [
  {
    title: 'Varity v0.1',
    description: 'Open-source PyPI package for LLM self-checking. Implements novel Verdict Stability Score (VSS) to statistically validate hallucination risk in production RAG pipelines.',
    tags: ['Python', 'LLM', 'Open Source', 'LLMOps'],
    icon: <Shield className="w-6 h-6" />,
    link: 'https://github.com/charchitd/varity',
  },
  {
    title: 'MCP Server — AI Fairness',
    description: 'Model Context Protocol server operationalising the 5P fairness framework. Enables Claude Code agents to audit AI recruitment systems for bias and parity.',
    tags: ['MCP', 'AI Ethics', 'Agentic Workflow'],
    icon: <Brain className="w-6 h-6" />,
    link: 'https://github.com/charchitd',
  },
  {
    title: 'Published Research (VTC 2020)',
    description: 'Peer-reviewed publication on ML models for vehicular network state prediction. 35+ citations. Demonstrates deep research to production capability.',
  ...
  {
    title: 'BookWise AI',
    description: 'Full-stack LLM SaaS: PDF ingestion → AI curriculum generator → AI tutor chatbot. Built with Next.js, Supabase, and Anthropic API.',
    tags: ['Next.js', 'Supabase', 'Anthropic', 'SaaS'],
