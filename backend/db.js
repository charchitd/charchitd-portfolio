...
const initializeDatabase = async () => {
    try {
        ...
        await pool.query(`DROP TABLE IF EXISTS experience`);
        await pool.query(`CREATE TABLE experience (
            id TEXT PRIMARY KEY,
            role TEXT,
            company TEXT,
            year TEXT,
        ...
        await pool.query(`DROP TABLE IF EXISTS thoughts`);
        await pool.query(`CREATE TABLE thoughts (
            id TEXT PRIMARY KEY,
            title TEXT,
            date TEXT,
            type TEXT,
